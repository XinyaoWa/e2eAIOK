...
TRAIN_FILE=$DATA_PATH"/textformat/data/viggo_mul/train.parquet"
VALID_FILE=$DATA_PATH"/textformat/data/viggo_mul/valid.parquet"
prompt_file_viggo_textformat=$DATA_PATH"/textformat/data/viggo_mul/prompt_mul"

MODEL_SAVE_PATH=$DATA_PATH"/textformat/models/viggo_mul/models"
model_save_path=${MODEL_SAVE_PATH}"/"${model_name}"-lora"
LOG_PATH=$DATA_PATH"/textformat/models/viggo_mul/log"
