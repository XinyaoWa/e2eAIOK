...
TRAIN_FILE=$DATA_PATH"/textformat/data/viggo/train.csv"
VALID_FILE=$DATA_PATH"/textformat/data/viggo/validation.csv"
prompt_file_viggo_textformat=$DATA_PATH"/textformat/data/viggo/prompt_textformat"

MODEL_SAVE_PATH=$DATA_PATH"/textformat/models/viggo/models"
model_save_path=${MODEL_SAVE_PATH}"/"${model_name}"-lora"
LOG_PATH=$DATA_PATH"/textformat/models/viggo/log"
