...
LOG_PATH=$DATA_PATH"/llama2_denas_neural_chat_recdp_v1/log"
MODEL_SAVE_PATH=$DATA_PATH"/llama2_denas_neural_chat_recdp_v1/models"

mkdir -p $LOG_PATH $MODEL_SAVE_PATH

# fine-tune with denas-lora
model_name="Llama-2-7b-hf"
dataset_list="train_recdp_v1.parquet"
