...
ALPACA_TRAIN_DATA="neural_chat/train"
ALPACA_VALID_DATA="neural_chat/valid_all.parquet"
MODEL_SAVE_PATH=$DATA_PATH"/llama2_denas_neural_chat_random_baseline/models"

mkdir -p $MODEL_SAVE_PATH

model_name="Llama-2-7b-hf"
dataset_list="train_sample.parquet"
...
do
    ...
    log_save_path=$model_output_path"/merge.log"
    ...
    log_save_path=$model_output_path"/valid-original.log"
    WANDB_DISABLED=true python -u example/instruction_tuning_pipeline/finetune_clm.py \
        --model_name_or_path $model_name_or_path \
        --train_file ${DATA_PATH}"/"${ALPACA_TRAIN_DATA}"/"${dataset_name} \
    ...
    log_save_path=$model_output_path"/valid-merge.log"
