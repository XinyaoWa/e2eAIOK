...
ALPACA_TRAIN_DATA="LLM_data/alpaca_train_parquet"
ALPACA_VALID_DATA="LLM_data/alpaca_valid_parquet/alpaca_data_valid.parquet"
LOG_PATH=$DATA_PATH"/llama2_denas_alpaca70_recdp/log"
MODEL_SAVE_PATH=$DATA_PATH"/llama2_denas_alpaca70_recdp/models"

mkdir -p $LOG_PATH $MODEL_SAVE_PATH

# fine-tune with denas-lora
model_name="Llama-2-7b-hf"
dataset_list="alpaca_data_train.parquet alpaca_data_90_32641.parquet  alpaca_data_95_34455.parquet  alpaca_data_97_35180.parquet"
